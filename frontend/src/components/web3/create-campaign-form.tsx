...
import { inkFundMe } from "@/lib/inkathon/deployments"
  ...
  const handleCreateCampaign = useCallback(async () => {
    ...
    try {
      ...
      const tx = contract
        ...
        .then((tx) => {
          if (!tx.ok) throw new Error("Failed to create campaign", { cause: tx.dispatchError })
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="goal">Funding Goal {tokenInfo && `(${tokenInfo.symbol})`}</Label>
            <Input
              id="goal"
              type="number"
              placeholder="1000"
        ...
        <Button onClick={handleCreateCampaign} disabled={isLoading || !signer} className="w-full">
