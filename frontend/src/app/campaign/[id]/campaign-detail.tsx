...
function CampaignDetailContent({ campaignId }: CampaignDetailPageProps) {
  ...
  if (!campaign) {
    return (
      <div className="py-12 text-center">
        ...
        <p className="mb-6 text-muted-foreground">The campaign you're looking for doesn't exist.</p>
  ...
  const timeLeft = !isExpired ? formatDistanceToNowStrict(deadlineDate, { addSuffix: false }) : null
      ...
      <div className="grid gap-6 lg:grid-cols-3">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="font-semibold text-lg">Funding Progress</span>
                ...
                <div className="flex justify-between text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold">
                      {formatTokenAmount(campaign.raised, tokenInfo?.decimals)} {tokenInfo?.symbol}
                    </span>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    {isExpired ? (
                      <span className="font-medium text-red-600">Campaign Expired</span>
                    ) : (
                      <span className="font-medium text-green-600">{timeLeft} remaining</span>
                    )}
                  </p>
                </div>
              </div>
              ...
              {isOwner && isExpired && !campaign.completed && (
                <>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Finalize Campaign</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <Button
              ...
              {/* Claim Refund */}
              {campaign.completed && !goalReached && userContribution > 0n && (
                <>
                  <Separator />
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Claim Refund</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <Button
        ...
        <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="text-center">
                  <p className="font-bold text-2xl">
                    {formatTokenAmount(tokenInfo.userBalance, tokenInfo.decimals)}
                  </p>
          ...
          {!campaign.completed && !isExpired && (
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Contribute to Campaign</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
